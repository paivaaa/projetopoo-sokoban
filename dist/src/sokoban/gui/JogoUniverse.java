...
/**
 * A classe JogoUniverse representa a interface gráfica do jogo Sokobaan na
 * variante universo. Ela contém métodos para inicialização da interface,
 * manipulação de eventos de teclado, atualização de estatísticas do jogo e
 * controle dos elementos gráficos.
 *
 * @author Tiago Paiva
 * @author Mário Bonacho
 */
public class JogoUniverse extends javax.swing.JFrame implements Runnable {
    ...
    public void setPuzzle(String puzzle) {
        sokobanUniverse1.setPuzzle(puzzle);
        for (int i = 1; i <= 60; i++) {
            if (puzzle.equals(PuzzlesUniverse.getPuzzleUniverse(i))) {
                numeroPuzzle = i;
                break;
            }
        }
    ...
    public void parametros() {
        //Contagem dos passos
        passosLabel.setText("Passos : " + sokobanUniverse1.getPassos());
        //Contagem de caixas arrastadas
        empurroesLabel.setText("Empurrões : " + sokobanUniverse1.getEmpurroes());
        if (sokobanUniverse1.isComplete()) {
            ...
            FimPuzzleUniverse fimjogo = new FimPuzzleUniverse(this, sokobanUniverse1);
    ...
    public void guardaNivelPuzzle() {
        ...
        guardarPuzzle = PuzzlesUniverse.getPuzzleUniverse(numeroPuzzle);
        sokobanUniverse1.setPuzzle(guardarPuzzle);
    }
    ...
    private void initComponents() {
        ...
        sokobanUniverse1 = new sokoban.SokobanUniverse();
        ...
        modojogoLabel.setText("Modo : Universo");
        ...
        getContentPane().add(sokobanUniverse1, java.awt.BorderLayout.CENTER);
    ...
    private void btnRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRestartActionPerformed
        // Botão restart
        sokobanUniverse1.apagarPuzzle();
        sokobanUniverse1.setPuzzle(PuzzlesUniverse.getPuzzleUniverse(numeroPuzzle));
        sokobanUniverse1.restartStatistics();
        passosLabel.setText("Passos: " + sokobanUniverse1.getPassos());
        empurroesLabel.setText("Empurrões : " + sokobanUniverse1.getEmpurroes());
        ini = System.currentTimeMillis();
    ...
    private void btnUndoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUndoActionPerformed
        // Botão Undo:
        sokobanUniverse1.undo(numeroPuzzle);
        passosLabel.setText("Passos: " + sokobanUniverse1.getPassos());
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_LEFT) {
            sokobanUniverse1.movePlayer(-1, 0, 1);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_RIGHT) {
            sokobanUniverse1.movePlayer(1, 0, 1);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
            sokobanUniverse1.movePlayer(0, -1, 1);
            parametros();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JogoUniverse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JogoUniverse().setVisible(true);
            }
        });
    }
    ...
    private sokoban.SokobanUniverse sokobanUniverse1;
    ...
    public void run() {
        while (true) {
            ...
            try {
                ...
                Logger.getLogger(JogoUniverse.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
