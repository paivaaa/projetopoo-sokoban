...
import sokoban.SokobanUniverse;

/**
 * A classe FimPuzzleUniverse representa a janela exibida ao completar um puzzle no modo universo do jogo Sokoban.
 * Esta janela exibe as estatísticas da partida (tempo decorrido, número de passos e empurrões) e oferece opções
 * para reiniciar o nível, avançar para o próximo nível ou retornar ao menu principal do modo universo.
 * 
 ...
 */
public final class FimPuzzleUniverse extends javax.swing.JFrame {

    private final JogoUniverse jogoUniverse1;
    private final SokobanUniverse sokobanUniverse;

    private int puzzle;
    private int proxPuzzle;
    /**
     * Cria uma nova instância da janela de fim de puzzle no modo universo.
     *
     * @param jogoUniverse1 O objeto JogoUniverse que controla o jogo no modo universo.
     * @param sokobanUniverse O objeto SokobanUniverse que representa o jogo no modo universo.
     */
    public FimPuzzleUniverse(JogoUniverse jogoUniverse1, SokobanUniverse sokobanUniverse) {
        this.jogoUniverse1 = jogoUniverse1;
        this.sokobanUniverse = sokobanUniverse;
        initComponents();
        //Muda o cor de fundo
    ...
    /**
     * Configura os parâmetros e texto exibidos na janela de fim de puzzle no modo universo.
     */
    public void parametros() {
        label_parabens.setText("Parabéns! Completaste o nível " + jogoUniverse1.getNumeroPuzzle() + " !");
        label_passos.setText("Passos : " + sokobanUniverse.getPassos());
        label_empurroes.setText("Empurrões : " + sokobanUniverse.getEmpurroes());
        label_tempo.setText("Tempo  : " + jogoUniverse1.getTempoDecorrido());
    }
    ...
    private void initComponents() {
        ...
        label_parabens.setText("Parabéns! Completas-te o nível !");
    ...
    private void btnNextLevelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextLevelActionPerformed
        // Botão proximo nivel:
        puzzle = jogoUniverse1.getNumeroPuzzle();
        proxPuzzle = puzzle +1;
        sokobanUniverse.apagarPuzzle();
        jogoUniverse1.setPuzzle(PuzzlesUniverse.getPuzzleUniverse(proxPuzzle));
        jogoUniverse1.atualizarNivelPuzzle();
        dispose(); // Fecha a janela atual 
        // Abre uma nova instância de JogoSingle com o novo puzzle
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jogoUniverse1.setVisible(true);
            }
        });
    ...
    private void btnRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRestartActionPerformed
        // Botão restart:
        jogoUniverse1.restartstats();
        sokobanUniverse.apagarPuzzle();
        sokobanUniverse.setPuzzle(jogoUniverse1.guardarPuzzle);
        dispose();
    }//GEN-LAST:event_btnRestartActionPerformed

    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        //Botão ao menu:
        MenuUniverse menuUniverse = new MenuUniverse();
        menuUniverse.setLocationRelativeTo(null);
        menuUniverse.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FimPuzzleUniverse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FimPuzzleUniverse(new JogoUniverse(), new SokobanUniverse()).setVisible(true);
            }
        });
    }
