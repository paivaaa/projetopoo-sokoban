...
/**
 * Esta classe representa a interface gráfica do jogo Sokoban na variante multiplayer.
 * Permite aos jogadores interagir com o jogo, visualizar informações sobre o jogo
 * e controlar as ações dos jogadores.
 * 
 * @author Tiago Paiva
 * @author Mário Bonacho
 */
public class JogoMulti extends javax.swing.JFrame implements Runnable {
    ...
    public void setPuzzle(String puzzle) {
        sokobanMulti1.setPuzzle(puzzle);
        for (int i = 1; i <= 60; i++) {
            if (puzzle.equals(PuzzlesMulti.getPuzzleMulti(i))) {
                numeroPuzzle = i;
                break;
            }
        }
    ...
    public void parametros() {
        //Contagem dos passos
        passosLabel.setText("Passos : " + sokobanMulti1.getPassos());
        //Contagem de caixas arrastadas
        empurroesLabel.setText("Empurrões : " + sokobanMulti1.getEmpurroes());
        if (sokobanMulti1.isComplete()) {
            ...
            FimPuzzleMulti fimjogo = new FimPuzzleMulti(this, sokobanMulti1);
    ...
    public void guardaNivelPuzzle() {
        ...
        guardarPuzzle = PuzzlesMulti.getPuzzleMulti(numeroPuzzle);
        sokobanMulti1.setPuzzle(guardarPuzzle);
    }
    ...
    private void initComponents() {
        ...
        sokobanMulti1 = new sokoban.SokobanMulti();
        ...
        modojogoLabel.setText("Modo : Multiplayer");
        ...
        sokobanMulti1.setBackground(new java.awt.Color(97, 153, 180));
        sokobanMulti1.setForeground(new java.awt.Color(97, 153, 180));
        getContentPane().add(sokobanMulti1, java.awt.BorderLayout.CENTER);
    ...
    private void btnRestartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRestartActionPerformed
        // Botão restart
        sokobanMulti1.apagarPuzzle();
        sokobanMulti1.setPuzzle(PuzzlesMulti.getPuzzleMulti(numeroPuzzle));
        sokobanMulti1.restartStatistics();
        passosLabel.setText("Passos: " + sokobanMulti1.getPassos());
        empurroesLabel.setText("Empurrões : " + sokobanMulti1.getEmpurroes());
        ini = System.currentTimeMillis();
    ...
    private void btnUndoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUndoActionPerformed
        // Botão Undo:
        sokobanMulti1.undo(numeroPuzzle);
        passosLabel.setText("Passos: " + sokobanMulti1.getPassos());
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_A) {
            sokobanMulti1.movePlayer(-1, 0, 1);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_D) {
            sokobanMulti1.movePlayer(1, 0, 1);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_W) {
            sokobanMulti1.movePlayer(0, -1, 1);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_S) {
            sokobanMulti1.movePlayer(0, 1, 1);
            parametros();
        }
        // Jogador 2 : Teclas UP, LEFT, DOWN, RIGHT:
        if (evt.getKeyCode() == KeyEvent.VK_LEFT) {
            sokobanMulti1.movePlayer(-1, 0, 2);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_RIGHT) {
            sokobanMulti1.movePlayer(1, 0, 2);
            parametros();
        } else if (evt.getKeyCode() == KeyEvent.VK_UP) {
            sokobanMulti1.movePlayer(0, -1, 2);
            parametros();
    ...
    private sokoban.SokobanMulti sokobanMulti1;
    ...
    public void run() {
        while (true) {
            ...
            try {
                ...
                Logger.getLogger(JogoMulti.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
