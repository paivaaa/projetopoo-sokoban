...
/**
 * Classe que representa a variante universo do jogo Sokoban.
 * 
 * @autor Tiago Paiva
 * @autor Mário Bonacho
 */
public class SokobanUniverse extends Sokoban {

    /**
     * Construtor padrão que inicializa o jogo.
     */
    public SokobanUniverse() {
        this(PuzzlesUniverse.getPuzzleUniverse1());
    }
     ...
     */
    public SokobanUniverse(String p) {
        super(p);
    }
